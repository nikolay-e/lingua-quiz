...
export class AuthenticationService {
   ...
   * @throws ApiError
   */
  public static registerUserApiAuthRegisterPost(requestBody: UserRegistration): CancelablePromise<TokenResponse> {
   ...
   * @throws ApiError
   */
  public static loginUserApiAuthLoginPost(requestBody: UserLogin): CancelablePromise<TokenResponse> {
    return __request(OpenAPI, {
      method: 'POST',
      url: '/api/auth/login',
      body: requestBody,
