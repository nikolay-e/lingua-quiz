...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      'flex h-10 w-full items-center justify-between rounded-lg border border-input bg-surface px-3 py-2 text-sm',
  ...
  ({ className, children, sublabel, ...props }, ref) => (
    ...
    >
      ...
      <div className="flex w-full items-center justify-between">
        ...
        {sublabel !== undefined && <span className="ml-2 text-xs text-muted-foreground">{sublabel}</span>}
      </div>
    </SelectPrimitive.Item>
  ),
);
